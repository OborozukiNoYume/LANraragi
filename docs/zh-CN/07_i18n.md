...
| `config_shinobu.html.tt2` | Shinobu 文件监视设置 |
...
<a href="[% c.url_for('/reader').query(id => arcid) %]">阅读</a>
```
...
const I18N = {
    ConfirmYes: "是",
    ConfirmDestructive: "您确定吗？",
    GenericReponseError: "服务器错误",
    // ...
};
```
...
msgstr "<b>~namespace</b> : 从标签中去除命名空间"
```
