...
> Baseline commit `6af7cd51` (2026-09-05). 中文版见 [zh-CN/](zh-CN/)。
...
| 04 | Plugin system — 4 types, 33 built-in plugins | [en](en/04_plugins.md) | [zh-CN](zh-CN/04_plugins.md) |
...
|--------|-------|
| Tracked files | 482 |
| Perl modules / scripts+tests | 102 / 45 |
| Model / Utils modules | 16 / 24 |
| Built-in plugins (login/metadata/download/script) | 4 / 22 / 3 / 4 |
